...
class TestWOSParser(unittest.TestCase):
    ...
    def test_add_linter_message_new_message(self) -> None:
        ...
        self.parser.add_linter_message(rule, position=position)
        expected_message = {
            "code": "W0005",
    ...
    def test_add_linter_message_different_position(self) -> None:
        ...
        self.parser.add_linter_message(rule, position=position1)
        self.parser.add_linter_message(rule, position=position2)
        expected_message1 = {
            "code": "W0005",
            "label": "operator-capitalization",
            "message": "Operators should be capitalized",
...
class TestWOSListParser(unittest.TestCase):
    ...
    def test_list_parser_case_4(self) -> None:
        ...
        try:
            ...
            pass
        self.assertEqual(
            list_parser.linter_messages[2][0],
            {
                "code": "F3003",
                "is_fatal": True,

...
Each serializer implements a function that takes a
:class:`search_query.query.Query` object and returns a string.
...
- Accept a :class:`search_query.query.Query` object.
